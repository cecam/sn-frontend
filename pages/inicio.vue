            ...
            <v-tab-item style="width : 100vw">
                <v-container fluid>
                    <v-row align="center" justify="space-around" >
                        ...
                        <v-col cols="11" md="5" v-if="documentos.length == 0">
                            <v-card-title >
                                Vaya, parece que aún no hay documentos con las etiquetas que elegiste
                            </v-card-title>
                        </v-col>
                        <v-col cols="11" sm="5" md="4" lg="3" v-else
                    ...
                    <v-row justify="center" >
                        ...
                        <v-card-title v-else>No hay más documentos para mostrar</v-card-title>
                    </v-row>
                </v-container>
            </v-tab-item>
            <v-tab-item style="width : 100vw">
                <v-container fluid>
                    ...
                    <v-row justify="center" >
                        ...
                        <v-card-title v-else>No hay más publicaciones para mostrar</v-card-title>
                    </v-row>
                </v-container>
            </v-tab-item>
        </v-tabs-items>
...
<script>
    ...
    import Template from '@/components/expandibles/Template'
